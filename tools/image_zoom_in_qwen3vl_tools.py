...
from core.tool import BaseToolWithFileAccess, register_tool
from utils.utils import extract_images_from_messages
...
class ImageZoomInToolQwen3VL(BaseToolWithFileAccess):
    ...
    def call(self, params: Union[str, dict], **kwargs):
        ...
        try:
            ...
            logger.warning(f'{e}')
            return [f'Error: Invalid input image {images}']
